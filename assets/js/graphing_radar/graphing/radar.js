...
const Radar = function (selector, size, radar) {
  ...
  function plotRadarHeader() {
    var header = d3.select(selector).insert('header', "#radar");
    header.append('div')
      .attr('class', 'radar-link-back')
      .html('<a href="/radars"> &lt;&lt;&lt; Back</a>')
    header.append('div')
  ...
  function plotRadarFooter() {
    d3.select(selector)
      ...
      .append('p')
      .html('Powered by <a href="https://www.carbonfive.com">Carbon Five</a>. ' +
        'This software is <a href="https://github.com/CarbonFive/TechRadar">open source</a> and available for download and self-hosting.');
  }

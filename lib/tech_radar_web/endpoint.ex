defmodule TechRadarWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :tech_radar

  socket("/socket", TechRadarWeb.UserSocket)

  # Enable concurrent testing
  if Application.get_env(:tech_radar, :sql_sandbox) do
